...
export function CardDemo() {
  return (
    <Card className="w-full md:w-5/6 lg:w-4/5 xl:w-3/4 h-auto">
    ...
    <div className="p-4 overflow-hidden h-full relative flex items-center justify-center">
      <div className="flex flex-row flex-wrap justify-center items-center gap-4 w-full">
        ...
        <Container className="h-14 w-14 circle-2">
          <GoCopilot className="h-7 w-7 dark:text-white" />
        </Container>
        ...
        <Container className="h-14 w-14 circle-6">
          <NodeJSLogo className="h-7 w-7 dark:text-white" />
        </Container>
        <Container className="h-12 w-12 circle-7">
          <NextJSLogo className="h-6 w-6 dark:text-white" />
        </Container>
      </div>
